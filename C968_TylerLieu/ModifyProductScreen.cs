...
namespace C968_TylerLieu
{
    public partial class ModifyProductScreen : Form
    {
        ...
        public Product currentProduct = MainScreen.currentProduct;
        public int currentProductIndex = MainScreen.currentProductIndex;
        public BindingList<Part> AssociatedParts = new BindingList<Part>();
        public ModifyProductScreen()
        {
            InitializeComponent();
            // Pre-Populating Fields
            txtbx_id.Text = Convert.ToString(currentProduct.ProductID);
            txtbx_name.Text = currentProduct.Name;
            txtbx_inventory.Text = Convert.ToString(currentProduct.InStock);
            txtbx_cost.Text = Convert.ToString(currentProduct.Price);
            txtbx_min.Text = Convert.ToString(currentProduct.Min);
            txtbx_max.Text = Convert.ToString(currentProduct.Max);
